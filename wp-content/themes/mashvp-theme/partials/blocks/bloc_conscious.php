<section class="consciousC" id="consciousC">
    <div class="conscious grid12 ma wi90">
        ...
        <div class="consciousimg rellax" data-rellax-speed="-2" data-rellax-mobile-speed="0" data-rellax-tablet-speed="0" data-rellax-desktop-speed="-2" style="background-image: url('<?= get_sub_field('image') ?>')"></div>
